...
# class detects the face that has a min confidence score of 50%
class FaceDetector():
    ...
    # function to find the faces in the frame.
    def findFaces(self, img, draw=True):
        ...
        if self.results.detections:
            for id, detection in enumerate(self.results.detections):
                ...
                # if draw is true then call the fancyDraw function.
                if draw:
    ...
    def fancyDraw(self, img, bbox, l=25, t=2, rt=1):
        x, y, w, h = bbox
        # x1, y1 are the diagonal coordinates of the bounding box.
        x1, y1 = x+w, y+h
